...
--An edit to fistweapon to allow for alt abilities
...
function update(dt, fireMode, shiftHeld)
  ...
  elseif fireMode == "primary" and (not self.needsEdgeTrigger or self.edgeTriggerTimer > 0) then
    if self.comboStep > 0 then
...
-- advance to the next step of the combo
function callFinisher()
  activeItem.callOtherHandScript("triggerComboAttack", self.comboSteps)
end

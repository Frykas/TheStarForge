...
StarforgeChargedShot = WeaponAbility:new()

function StarforgeChargedShot:init()
...
function StarforgeChargedShot:update(dt, fireMode, shiftHeld)
...
function StarforgeChargedShot:charge()
...
function StarforgeChargedShot:fire()
...
function StarforgeChargedShot:burst()
  self.weapon:setStance(self.stances.fire)
...
function StarforgeChargedShot:fireProjectile(burstNumber)
...
function StarforgeChargedShot:muzzleFlash()
...
function StarforgeChargedShot:cooldown()
...
function StarforgeChargedShot:firePosition()
  return vec2.add(mcontroller.position(), activeItem.handPosition(self.weapon.muzzleOffset))
end

function StarforgeChargedShot:aimVector(inaccuracy, shotNumber, burstNumber)
...
function StarforgeChargedShot:energyPerShot()
  if self.fireType == "burst" then
...
function StarforgeChargedShot:damagePerShot()
  if self.fireType == "burst" then
...
function StarforgeChargedShot:updateChargeIntake(chargeTimeLeft)  
...
function StarforgeChargedShot:uninit()
  self:reset()
end

function StarforgeChargedShot:reset()
  animator.setAnimationState("charge", "off")
  animator.setParticleEmitterActive("chargeparticles", false)
  self.chargeHasStarted = false
